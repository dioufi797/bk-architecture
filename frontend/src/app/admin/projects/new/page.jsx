      ...
      <main className="flex-1 overflow-auto pt-14 lg:pt-0">
        <div className="p-4 sm:p-6 lg:p-8">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className="font-display text-xl sm:text-2xl font-bold text-white">Nouveau projet</h1>
              <p className="text-dark-400 text-xs sm:text-sm mt-0.5">Remplissez les informations</p>
            </div>
          </div>
